...
NM_SETTING_REGISTER_TYPE (NM_TYPE_SETTING_SRIOV)
...
nm_setting_sriov_class_init (NMSettingSriovClass *setting_class)
{
	 ...
	 * If set to %NM_TERNARY_DEFAULT, the global default is used and
	 * in case no global default exists, drivers are autoprobed.
	 *
	 * Since: 1.14
	 **/
	/* ---ifcfg-rh---
